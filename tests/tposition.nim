...
suite "placePiece / removePiece / isOccupied":
  ...
  test "removePiece clears occupied":
    var pos: Position
    pos.placePiece(0, Color.White, King)
    pos.removePiece(0, Color.White, King)
    check pos.isOccupied(0) == false
 
  test "placePiece sets color bitboard":
    var pos: Position
    pos.placePiece(5, Color.Black, Queen)
  ...
  test "placePiece sets piece bitboard":
    var pos: Position
    pos.placePiece(12, Color.White, Rook)
    check testBit(pos.pieces[Color.White][Rook], 12) == true
 
  test "removePiece clears piece bitboard":
    var pos: Position
    pos.placePiece(12, Color.White, Rook)
    pos.removePiece(12, Color.White, Rook)
    check testBit(pos.pieces[Color.White][Rook], 12) == false
  ...
  test "multiple pieces can coexist":
    var pos: Position
    pos.placePiece(0,  Color.White, Rook)
    pos.placePiece(7,  Color.White, Rook)
    pos.placePiece(56, Color.Black, Rook)
    pos.placePiece(63, Color.Black, Rook)
    check pos.isOccupied(0)  == true
...
suite "colorAt":
  test "white piece returns Color.White":
    var pos: Position
    pos.placePiece(4, Color.White, King)
    check pos.colorAt(4) == Color.White
 
  test "black piece returns Color.Black":
    var pos: Position
    pos.placePiece(60, Color.Black, King)
